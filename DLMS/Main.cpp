...
int main()
{
...

    {
        ...
        uint8_t     getRequest1[]       = {0x7e,0xa0,0x19,0x03,0x41,0x32,0x3a,0xbd,0xe6,0xe6,0x00,0xc0,0x01,0x81,0x00,0x01,0x00,0x00,0x60,0x01,0x01,0xff,0x02,0x00,0x37,0x71,0x7e};
        uint8_t     getResponse1[]      = {0x7e,0xa0,0x18,0x41,0x03,0x52,0x9f,0x04,0xe6,0xe7,0x00,0xc4,0x01,0x81,0x00,0x09,0x06,0x45,0x6c,0x73,0x74,0x65,0x72,0xa2,0x4d,0x7e};
        uint8_t     getFWVersionRqst[]  = {0x7e,0xa0,0x19,0x03,0x41,0x98,0x6a,0xb7,0xe6,0xe6,0x00,0xc0,0x01,0x81,0x00,0x01,0x01,0x00,0x00,0x02,0x00,0xff,0x02,0x00,0x4e,0x76,0x7e};
        uint8_t     getFWVersionResp[]  = {0x7e,0xa0,0x1d,0x41,0x03,0xb8,0x9c,0x22,0xe6,0xe7,0x00,0xc4,0x01,0x81,0x00,0x09,0x0b,0x41,0x31,0x36,0x33,0x30,0x2e,0x31,0x31,0x2e,0x30,0x31,0x0b,0x98,0x7e};
        ...
        //ByteStream  requestStream( &getRequest1[0], sizeof(getRequest1) );
        //ByteStream  requestStream( &getResponse1[0], sizeof(getResponse1) );
        //ByteStream  requestStream( &getFWVersionRqst[0], sizeof(getFWVersionRqst) );
        ByteStream  requestStream( &getFWVersionResp[0], sizeof(getFWVersionResp) );
