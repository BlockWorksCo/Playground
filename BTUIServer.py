...
# hcitool -i hci0 cmd 0x08 0x0008 1e 02 01 16 1a ff 4c 00 02 15 e2 c5 6d b5 df fb 48 d2 b0 60 d0 f5 a7 10 96 e0 00 00 00 00 c5 00 00 00 00 00 00 00 00 00 00 00 00 00
# hcitool -i hci0 cmd 0x08 0x0008 1e 02 01 16 7 ff 4c 00 42 54 55 49 00 00 00
# hciconfig hci0 leadv 0

#
# 504f4e4d-4c4b-4a49-4847-464544434241 is the service UUID from:
# hcitool -i hci0 cmd 0x08 0x0008 15 02 01 1a 11 07 41 42 43 44 45 46 47 48 49 4a 4b 4c 4d 4e 4f 50
#
# so:
# 6E400001-B5A3-F393-E0A9-E50E24DCCA9E is the service UUID from:
# hcitool -i hci0 cmd 0x08 0x0008 15 02 01 1a 11 07 9e ca dc 24 0e e5 a9 e0 93 f3 a3 b5 01 00 40 6e
#
...
class UARTService(Service):
    ...
    """
    BATTERY_UUID = '6E400001-B5A3-F393-E0A9-E50E24DCCA9E'
...
class UART_TX(Characteristic):
    ...
    """
    BATTERY_LVL_UUID = '6E400002-B5A3-F393-E0A9-E50E24DCCA9E'
...
class UART_RX(Characteristic):
    ...
    """
    BATTERY_LVL_UUID = '6E400003-B5A3-F393-E0A9-E50E24DCCA9E'
