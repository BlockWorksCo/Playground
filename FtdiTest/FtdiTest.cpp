...
//----------------------------------------------------------------------------------------------------------------
    ...
    #define AFK_RUN_ASYNC_245 false
...
double stopTiming()
{
    ...
    uint32_t    elapsedMicroseconds = (end.tv_sec * 1e6 + end.tv_usec - (start.tv_sec * 1e6 + start.tv_usec));

    double  elapsedSeconds  = ((double)elapsedMicroseconds) / 1000000.0;
